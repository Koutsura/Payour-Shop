...
import 'package:pshop_aplikasi/controllers/chats_controller.dart';
import 'package:pshop_aplikasi/services/firestore_services.dart';
import 'package:pshop_aplikasi/views/chat_screen/components/sender_bubble.dart';
        ...
        child: Column(
          children: [
            ...
            controller.isLoading.value ? Center(
              ...
              : Expanded(child: StreamBuilder(stream: FirestoreServices.getChatMessages(controller.chatDocId.toString()),
            ...
            ).box.height(60).padding(const EdgeInsets.all(12)).margin(const EdgeInsets.only(bottom: 8)).make(),
          ],
        ),
      ),
    );
